...
import com.dubizzle.core.R
import com.dubizzle.core.common.Constants
import com.dubizzle.core.common.Constants.LANG_CODE_ARABIC
import com.dubizzle.core.common.Constants.LANG_CODE_ENGLISH
import com.dubizzle.core.common.SharedPrefConstants
import com.dubizzle.classifieds.utils.PreferenceUtil.get
import com.dubizzle.classifieds.utils.PreferenceUtil.set
...
object LocaleManager {
    ...
    private fun getCurrentLanguage(context: Context?): String? {
        ...
        currentLanguage = nonNullSharedPref[SharedPrefConstants.SELECTED_LANGUAGE] ?: LANG_CODE_ENGLISH

        return currentLanguage
    }

    private fun getLocale(): String =
        getCurrentLanguage(ClassifiedsApp.localeContext())
            ?: Locale.getDefault().language.toString()

    fun isArabic(): Boolean = getLocale().equals(LANG_CODE_ARABIC, ignoreCase = true)
